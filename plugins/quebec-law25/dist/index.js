  ...
  framework: {
    ...
    structure: [
      ...
      },
      {
        ...
        items: [
          {
            title: "Art. 2.1 - Consent Principles",
            description: "Obtain consent that is manifest, free, enlightened, and given for specific purposes",
            order_no: 1,
            summary: "Consent must be clear (manifest), voluntary (free), informed (enlightened), and purpose-specific. Bundled consent is prohibited. Consent requests must be in clear and simple language",
            questions: [
              "Is consent obtained before or at the time of collection?",
              "Is consent request presented in clear and simple language?",
              "Is consent purpose-specific and not bundled?",
              "Can individuals refuse consent without penalty for non-essential purposes?"
            ],
            evidence_examples: [
              "Consent forms and mechanisms",
              "Consent language review documentation",
